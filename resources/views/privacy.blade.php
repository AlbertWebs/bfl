                            ...
                            <div class="col-lg-10 offset-lg-1">
                                ...
                                <h1 class="hs-title-9 mb-10">
                                    <span class="wow charsAnimIn" data-splitting="chars">
                                         <span class="mark-decoration-3-wrap" style="color:#1A383C">Privacy Policy<b class="wow scalexIn" data-wow-delay="0.5s"></b></span>
                                    </span>
                                </h1>
                        ...
                        <div class="row mb-70 mb-sm-50">
                            ...
                            <div class="col-lg-12 col-xl-10 mb-md-40" style="margin:0 auto">
                                ...
                                <p class="section-descr mb-0">
                                        ...
                                        <h2>Privacy Policy for Business for Life</h2>
                                        <p><strong>Effective Date: 24th October 2024</strong></p>

                                        <p>
                                            At Business for Life, we are committed to protecting your privacy and ensuring that your personal information is handled in a safe and responsible manner. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website <a href="https://businessforlife.empoweringlives.org">https://businessforlife.empoweringlives.org</a> or engage with our services.
                                        </p>

                                        <h3>1. Information We Collect</h3>
                                        <p>We may collect personal and non-personal information in several ways, including but not limited to:</p>
                                        <ul>
                                            <li><strong>Personal Information:</strong> Name, email address, phone number, mailing address, and any other information you voluntarily provide when you fill out forms on our website, subscribe to our newsletter, or communicate with us.</li>
                                            <li><strong>Non-Personal Information:</strong> IP address, browser type, device information, and browsing behavior on our site collected through cookies and similar technologies.</li>
                                        </ul>
                                        ...
                                        <ul>
                                            ...
                                            <li>To improve your experience on our website and tailor content to your preferences.</li>
                                            <li>To process your requests, subscriptions, or inquiries.</li>
                                            <li>To communicate with you regarding updates, promotions, and relevant offers, provided you have opted in to receive such communications.</li>
                                            <li>To improve our website through data analytics and research.</li>
                                            <li>To comply with legal obligations and enforce our terms and conditions.</li>
                                        </ul>

                                        <h3>3. Cookies and Tracking Technologies</h3>
                                        <p>
                                            Our website uses cookies to enhance user experience and analyze site usage. Cookies are small data files stored on your device that help us understand how you interact with our site. You can control the use of cookies through your browser settings.
                                        </p>

                                        <h3>4. Third-Party Services</h3>
                                        <p>
                                            We may use third-party service providers to support our business operations, such as payment processors, analytics services, or marketing partners. These providers may have access to your personal information but are obligated to protect it and only use it for the purposes for which it was shared.
                                        </p>
                                        ...
                                        <ul>
                                            ...
                                            <li>To protect the rights, property, or safety of Business for Life, our users, or others.</li>
                                        </ul>

                                        <h3>6. Data Security</h3>
                                        <p>
                                            We implement appropriate security measures to protect your information from unauthorized access, disclosure, or destruction. However, please note that no data transmission over the internet is completely secure, and we cannot guarantee the absolute security of your information.
                                        </p>

                                        <h3>7. Your Rights</h3>
                                        <p>You have the right to:</p>
                                        <ul>
                                            <li>Access, correct, or delete your personal information that we hold.</li>
                                            <li>Opt out of receiving marketing communications at any time.</li>
                                            <li>Request the limitation of certain data processing activities.</li>
                                        </ul>
                                        <p>To exercise these rights, please contact us at <a href="mailto:privacy@businessforlife.empoweringlives.org">privacy@businessforlife.empoweringlives.org</a>.</p>
                                        ...
                                        <p>
                                            <strong>Business for Life</strong><br>
                                            Email: <a href="mailto:privacy@businessforlife.empoweringlives.org">privacy@businessforlife.empoweringlives.org</a><br>
                                            Phone:+254 721 179 061<br>
                                            Address: Shalom House, Block C, St Daniel Comboni Rd, Off Ngong Road
                                        </p>
                                        <p>
                                            This Privacy Policy was last updated on 24th October 2024.
                                        </p>
