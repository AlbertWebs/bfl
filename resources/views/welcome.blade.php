                ...
                <section class="home-section light-content" id="home">
                    <div class="container min-height-100vh d-flex align-items-center pt-100 pb-100 pt-sm-120 pb-sm-120">
                        ...
                        <div class="home-content pt-20 pt-md-0 text-center">
                            ...
                            <h2 class="section-title-tiny font-alt mb-40 mb-sm-30 wow charsAnimIn" data-splitting="chars" style="font-size:30px">Equipping those struggling to survive so that they can build fulfilling and prosperous lives</h2>
